...
$memes = $use->getCategoryIndexMemes($nya, $limit, $_GET['url']);
$mp = $use->getCategoryIndexMemes(0, 99999999, $_GET['url']);
$memePage = ceil(count($mp) / $limit);

$category = $use->getCategoryByUrl($_GET['url']);
$topAuthor = $use->getTopAuthor($category['id_category'])
?>
<!DOCTYPE html>
<html class="no-js">
<head>
                ...
                <div class="row">
                    <div class="category-wrap">
                        ...
                        <div class="col-sm-2 border-right">
                            <div class="outer">
                                <div class="inner">
                                    <div class="total-posts"><?= $category['category_memes'] ?></div>
                        ...
                        <div class="col-sm-6">
                            <div class="outer">
                                <div class="inner">
                                    <figure>
                                        <img src="img/user-big.png" alt=""/>
                                    </figure>
                                    <div class="text">
                                        <h4>top author</h4>
                                        <div class="separator"></div>
                                        <a href="profile.php?url=<?= $topAuthor['path'] ?>" class="user-name"><?=$topAuthor['name'] ?></a>
                                        <div class="counters">
                                            <span class="item"><?= $topAuthor['total_post']; ?> posts</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="main-wrap">
                            <?php if ($memePage > $page): ?>
                                ...
                                <div class="button-next-post">
                                    <a href="category.php?url=<?= $_GET['url'] ?>&page=<?= $page + 1 ?>">Next Post <i
                                    ...
                                    <div class="article-top">
                                        ...
                                        <div class="counters-line">
                                            <div class="pull-left">
                                                ...
                                                <div class="comments"><i class="icon-comments"></i> <a
                                                            href="post.php?uid=<?= $meme['id_meme'] ?>">Comments</a>
                                                </div>
                                            </div>
