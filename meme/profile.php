...
$memberData = $use->getUserByUrl($_GET['url']);
$memes = $use->getPostByUser($memberData['id']);
$userPostUser = $use->getPostByUser($memberData['id']);
$userVoteUser = $use->getVoteByUser($memberData['id']);
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-9 right-content profile-bg">
                <div class="row">
                    <div class="profile-wrap" style="background-image: url('img/user-cover.jpg');">
                        <div class="col-sm-9">
                            <div class="outer">
                                <div class="inner">
                                    <figure>
                                    ...
                                    <div class="text">
                                        <div class="outer">
                                            <div class="inner">
                                                <a href="#" class="user-name"><?= $memberData['name'] ?></a>
                                                <div class="counters"><?= count($voteUser) ?> Votes</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="outer">
                                <div class="inner">
                                    <div class="counter-item">
                                        <span class="number"><?= count($userVoteUser) ?></span><br/>
                                        <span class="exp">votes</span>
                                    </div>
                                    <div class="counter-item">
                                        <span class="number"><?= count($userPostUser) ?></span><br/>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="main-wrap">
                            <h1>posts by <?= $memberData['name'] ?></h1>
